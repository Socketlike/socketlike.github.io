  ...
  Page: (): React.ReactElement => (
    <BaseSite>
      <div className='content'>
        ...
        <br />
        You can use them by appending <code>$schema</code> as a key to your{' '}
        <code>manifest.json</code> with one of these as the value:
        <ul>
          <li>
            <a href='./addon.schema.json'>
              https://socketlike.github.io/replugged/addon.schema.json
            </a>{' '}
          ...
          <li>
            <a href='./theme.schema.json'>
              https://socketlike.github.io/replugged/theme.schema.json
            </a>{' '}
            (theme)
          </li>
        </ul>
